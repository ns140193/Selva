...
public class RPTestCaseHandler extends TestCaseHandler implements PrimaryHandler {
        ...
        try {
            ...
            if (isRPEnabled()) {
                try {
                    ...
                    sendLog(getRPValue("rp.endpoint"), getRPValue("rp.uuid"), RunManager.getGlobalSettings().getTestSet(), getRPValue("rp.project"), testcasename,
    ...
    public Status finalizeReport() {
        ...
        printReport();*/
        //System.out.println("report.getCurrentStatus() : " + report.getCurrentStatus());
    ...
    public void startItem(String rp_endpoint, String rp_uuid, String rp_launch, String rp_project, String launchId,
        ...
        ReportPortalClient.startItem(rp_endpoint, rp_uuid, rp_launch, rp_project, launchId, testcaseName);
    }
    
    public void sendLog(String rp_endpoint, String rp_uuid, String rp_launch, String rp_project, String testitemID,
            String status, String teststepdata, String filename) throws IOException, ParseException {
        ReportPortalClient.sendLog(rp_endpoint, rp_uuid, rp_launch, rp_project, testitemID, status, teststepdata, filename);
